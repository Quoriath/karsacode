    ...
    yield* Effect.acquireUseRelease(
      ...
      Effect.fn("captureCheckpoint.withTempDirectory")(function* (tempDir) {
        ...
        const commitEnv: NodeJS.ProcessEnv = {
          ...
          GIT_AUTHOR_NAME: "KarsaCode",
          GIT_AUTHOR_EMAIL: "karsacode@users.noreply.github.com",
          GIT_COMMITTER_NAME: "KarsaCode",
          GIT_COMMITTER_EMAIL: "karsacode@users.noreply.github.com",
        };
