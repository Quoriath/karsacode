// This file mostly exists because we want dev mode to say "KarsaCode (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "KarsaCode (Dev)" : "KarsaCode (Alpha)";
const APP_BUNDLE_ID = isDevelopment ? "com.t3tools.karsacode.dev" : "com.t3tools.karsacode";
