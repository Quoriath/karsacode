  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new KarsaCode prerelease is available for nightly testers."
          : "A new KarsaCode latest release is available.",
...
).pipe(Command.withDescription("Post a KarsaCode release announcement to Discord."));
